...
public class NetScramble extends AppCompatActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (itemId == R.id.menu_new) {
		...
		} else if (itemId == R.id.menu_scores) {
			...
			showAbout();
		} else if (itemId == R.id.skill_novice) {
			startGame(Skill.NOVICE);
		} else if (itemId == R.id.skill_normal) {
			startGame(Skill.NORMAL);
		} else if (itemId == R.id.skill_expert) {
			startGame(Skill.EXPERT);
		} else if (itemId == R.id.skill_master) {
			startGame(Skill.MASTER);
		} else if (itemId == R.id.skill_insane) {
			startGame(Skill.INSANE);
		} else if (itemId == R.id.sounds_off) {
			setSoundMode(SoundMode.NONE);
		} else if (itemId == R.id.sounds_qt) {
			setSoundMode(SoundMode.QUIET);
		} else if (itemId == R.id.sounds_on) {
			setSoundMode(SoundMode.FULL);
		} else if (itemId == R.id.anim_off) {
			setAnimEnable(false);
		} else if (itemId == R.id.anim_on) {
			setAnimEnable(true);
		} else if (itemId == R.id.menu_autosolve) {
			solverUsed = true;
			boardView.autosolve();
		} else {
